...
$d\nu = \nu_{i+\frac{1}{2}} - \nu_{i-\frac{1}{2}}$.  
%This slight variation in methodology was shown to produce the same results, within error.
...
%Absorption lines listed in Table~\ref{tab:features} can be used in classifying spectral types of cool stars~\cite{Rayner_2009}.  
...
{\bf Look at commented out lists above...and Discuss:}\\
\begin{itemize}
	\item{} which lines were chosen and why
	\item{} how do the lines map to spt type...lum class
