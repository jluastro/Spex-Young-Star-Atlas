...
$\Delta\lambda$ the difference between subsequent wavelength bins; $\Delta\lambda = \lambda_{i+1} - \lambda_{i}$.  To subtract adjacent wavelength bins in this fashion, $\lambda_{n}$ was appended to the end of the wavelength array.\\
