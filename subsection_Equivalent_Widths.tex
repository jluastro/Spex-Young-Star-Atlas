...
Equivalent width (EW) and associated uncertainty values were calculated using Equations~\ref{eq:EW}~and~\ref{eq:EWvar}~\cite{Cushing_2005}. 
where $f(\lambda_{i})$ is
$f_{c}(\lambda_{i})$ is
$\sigma(\lambda_{i})$ is
