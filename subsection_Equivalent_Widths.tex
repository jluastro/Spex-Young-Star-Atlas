...
$\Delta\lambda$ the difference between subsequent wavelength bins; $\Delta\lambda = \lambda_{i+1} - \lambda{i}$.  To subtract adjacent wavelength bins in this fashion, $\lambda_{N}$ was appended to the end of the wavelength array.
