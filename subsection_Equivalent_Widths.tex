...
Equivalent width (EW) values and variance were calculated using Equations~\ref{eq:EW}~and~\ref{eq:EWvar}~\cite{Cushing_2005}. %Calculation of equivalent width values was done using Equations~\ref{eq:EW}~and~\ref{eq:EWvar}~\cite{Cushing_2005}.
